 ...
 */
export declare type ChangeOptions<T> = {
 ...
 * @typeParam T - The type of value contained in the document
 */
export declare type ApplyOptions<T> = {
    patchCallback?: PatchCallback<T>;
};
/**
 ...
 */
export declare type ChangeFn<T> = (doc: T) => void;
/**
 ...
 */
export declare type PatchCallback<T> = (patch: Patch, before: Doc<T>, after: Doc<T>) => void;
/** @hidden **/
 ...
 */
export declare type InitOptions<T> = {
